...
test.describe('Actuarial Analytics Endpoints', () => {
  // Skip in CI (needs real backend API server)
  ...
  ciSkip(
    'GET /api/admin/actuarial/performance-metrics should return valid aggregated latency upper-bounds',
    async ({ request }) => {
  ...
  ciSkip(
    'GET /api/admin/actuarial/analytics should return valid daily bucket aggregation structure without regressions',
    async ({ request }) => {

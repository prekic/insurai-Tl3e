...
const mockSettings = {
  ai: [
    ...
    { key: 'anthropic_extraction_model', value: 'claude-sonnet-4-20250514', valueType: 'string', description: 'Anthropic model' },
  ...
  evaluation: [
    ...
    { key: 'strict_compliance', value: true, valueType: 'boolean', description: 'Strict compliance' },
    { key: 'include_optional_coverages', value: true, valueType: 'boolean', description: 'Include optional' },
    { key: 'use_regional_benchmarks', value: true, valueType: 'boolean', description: 'Regional benchmarks' },
  ],
  rate_limits: [
    { key: 'ai_extraction_max_requests', value: 20, valueType: 'number', description: 'AI extraction max' },
  ...
  ocr: [
    { key: 'skip_ocr_threshold', value: 0.85, valueType: 'number', description: 'Skip OCR threshold' },
    { key: 'selective_ocr_threshold', value: 0.60, valueType: 'number', description: 'Selective OCR threshold' },
    { key: 'timeout_seconds', value: 30, valueType: 'number', description: 'Timeout' },
    { key: 'max_pages_quick_analysis', value: 5, valueType: 'number', description: 'Max pages quick' },
    { key: 'chars_per_page_threshold', value: 200, valueType: 'number', description: 'Chars per page' },
  ],
}

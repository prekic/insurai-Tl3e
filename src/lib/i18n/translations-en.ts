...
export const EN_TRANSLATIONS: TranslationDictionary = {
  ...
  tryAnalysis: {
    ...
    detectedLanguage: 'Language: {lang}',
    tips: {
      tip1: '💡 Did you know? Kasko policies in Türkiye usually exclude flood damage from underground parking.',
      tip2: "💡 We're cross-checking your coverage against SEDDK 2026 minimum limits.",
      tip3: '💡 Your insured value is being matched against current market rayiç data.',
      tip4: '💡 We never store your document beyond this session unless you sign up.',
      tip5: '💡 KVKK compliance: your file is processed in-memory only.',
    },

...
const HIGH_PERFORMANCE: SettingsTemplate = {
  ...
  description: 'Maximize extraction accuracy and speed with higher resource usage. Best for production environments with high throughput needs.',
  icon: 'Rocket',
  color: 'blue',
  ...
  overrides: [
    ...
    { category: 'ocr', key: 'skip_ocr_threshold', value: 0.90 },
...
const COST_OPTIMIZED: SettingsTemplate = {
  id: 'cost_optimized',
  name: 'Cost Optimized',
  description: 'Reduce API costs by using lighter models and fewer calls. Suitable for development, testing, or budget-conscious deployments.',
  icon: 'Wallet',
  color: 'green',
  ...
  overrides: [
    ...
    { category: 'ai', key: 'anthropic_extraction_model', value: 'claude-3-5-haiku-20241022' },
    ...
    { category: 'ocr', key: 'skip_ocr_threshold', value: 0.70 },
...
const BALANCED: SettingsTemplate = {
  ...
  description: 'The recommended configuration balancing accuracy, speed, and cost. Resets all settings to their default values.',
  icon: 'Scale',
  color: 'gray',
  ...
  overrides: [
    ...
    { category: 'ai', key: 'anthropic_backup_model', value: 'claude-3-5-haiku-20241022' },
    ...
    { category: 'ocr', key: 'selective_ocr_threshold', value: 0.60 },
...
const STRICT_COMPLIANCE: SettingsTemplate = {
  ...
  description: 'Emphasize regulatory compliance and coverage quality in evaluations. Best for brokers and compliance officers.',
  icon: 'ShieldCheck',
  color: 'purple',
  ...
  overrides: [
    ...
    { category: 'ai', key: 'consensus_enabled', value: true },
    { category: 'ai', key: 'consensus_agreement_threshold', value: 0.90 },
    ...
    { category: 'fuzzy_matching', key: 'default_threshold', value: 0.90 },
    { category: 'fuzzy_matching', key: 'policy_number_threshold', value: 0.90 },
...
const QUICK_DEMO: SettingsTemplate = {
  id: 'quick_demo',
  name: 'Quick Demo',
  description: 'Optimized for fast demos and presentations. Short timeouts, relaxed validation, and faster UI updates.',
  icon: 'Presentation',
  color: 'amber',
  ...
  overrides: [
    ...
    { category: 'ocr', key: 'skip_ocr_threshold', value: 0.60 },
...
export function computeTemplateDiff(
  ...
  for (const override of template.overrides) {
    ...
    const normalizedCurrent = typeof currentValue === 'string' && !isNaN(Number(currentValue))
      ? Number(currentValue)
      : currentValue

...
2. **Upload Ray Sigorta PDF fixture (still deferred)**: Original `KRK_35_VD_458_Kasko_Police_32630901_3.pdf` not in repo. Drop into `policies/` (committed, CI) or `test-data/` (gitignored). Add fixture entry to `src/lib/ai/__tests__/qa-pdf-golden.test.ts`: premium 755.21 TL, 17 DAHİL + 10 HARİÇ, vehicle IVECO/KAMYON 80-12 1997, plate 35 VD 458.

...
- **Last Updated**: March 15, 2026 (Dynamic AI Guidelines, Eliminating Hardcoded AI Rules, Evidence Tracking JSON Schema translation requirements, proxy timeout handling, VKN/TC Kimlik fixes, Vitest worker crash fixes)

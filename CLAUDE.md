...
- **Last Updated**: April 11, 2026 (Pilot batch Phase A: `scripts/pilot-batch-ingest.ts` extended with Document AI OCR fallback + `policies` table writer + preflight validation. Commit `e1174df`. Phase B/C still blocked on env delivery.)

...
1. **Merge branch `claude/load-project-context-RJ0Qd` → main**: 2 commits ahead of `origin/main` — `1ed2284` (Ray Sigorta scanned PDF fixture) + `93c56bd` (audit-only mode for date-corruption script). Suggested squash-merge title in the active PR-title section below. Release-please will pick the dominant `feat` type.

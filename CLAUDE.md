...
- **Last Updated**: April 9, 2026 (Schema unified into `shared/extraction-schema.ts`; server rootDir changed to `..`; deployment paths updated to `dist-server/server/`; 6 pre-existing diagnose test timeouts fixed; migrations 042+043 applied to production)

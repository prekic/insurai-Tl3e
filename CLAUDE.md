...
1. **Unfinished Tasks**: There is one piece of pending E2E technical debt. An empty Playwright skeleton (`e2e/test_fx_ui.spec.ts`) was committed during the UI alignment sweep. This file needs to be populated with assertions to test the currency switching in the preferences panel before the FX feature is considered fully vetted in E2E.

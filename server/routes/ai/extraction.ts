  ...
  async (req: Request, res: Response) => {
    ...
    try {
      ...
      const dsOutputSchema =
        ...
        '  ]\n' +
        '}\n' +
        'IMPORTANT: Replace placeholder values ("string_from_doc", 12345, 500000, etc.) with actual data ' +
        'from the document above. Add more coverages. Use null for missing. Do NOT make up values.'
